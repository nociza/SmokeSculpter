...
(function () {
  ...
  const FILL_VIEWPORT_VERTEX_SHADER_SOURCE = `#version 300 es
...
`;
  ...
  const INITIALIZE_VELOCITY_FRAGMENT_SHADER_SOURCE = `#version 300 es
...
`;
  ...
  const INITIALIZE_SMOKE_FRAGMENT_SHADER_SOURCE = `#version 300 es
precision highp float;
out vec2 o_smoke;
...
`;
  ...
  const ADD_BUOYANCY_FORCE_FRAGMENT_SHADER_SOURCE = `#version 300 es
precision highp float;
out vec3 o_velocity;
uniform int u_cellNum;
uniform int u_cellTextureSize;
...
`;
  ...
  const ADVECT_VELOCITY_FRAGMENT_SHADER_SOURCE = `#version 300 es
precision highp float;
out vec3 o_velocity;
uniform int u_cellNum;
uniform int u_cellTextureSize;
...
`;
  ...
  const COMPUTE_PRESSURE_FRAGMENT_SHADER_SOURCE = `#version 300 es
precision highp float;
...
`;
  ...
  const ADD_PRESSURE_FORCE_FRAGMENT_SHADER_SOURCE = `#version 300 es
precision highp float;
out vec3 o_velocity;
uniform int u_cellNum;
uniform int u_cellTextureSize;
...
`;
  ...
  const DECAY_VELOCITY_FRAGMENT_SHADER_SOURCE = `#version 300 es
precision highp float;
out vec3 o_velocity;
uniform sampler2D u_velocityTexture;
uniform float u_deltaTime;
...
`;
  ...
  const ADVECT_SMOKE_FRAGMENT_SHADER_SOURCE = `#version 300 es
precision highp float;
out vec2 o_smoke;
uniform int u_cellNum;
uniform int u_cellTextureSize;
...
`;
  ...
  const ADD_SMOKE_FRAGMENT_SHADER_SOURCE = `#version 300 es
precision highp float;
out vec2 o_smoke;
uniform int u_cellNum;
uniform int u_cellTextureSize;
...
`;
  ...
  const RAYMARCH_VERTEX_SHADER_SOURCE = `#version 300 es
...
`;
  ...
  const RENDER_VELOCITY_FRAGMENT_SHADER_SOURCE = `#version 300 es
precision highp float;
in vec3 v_position;
in vec3 v_normal;
out vec4 o_color;
...
`;
  ...
  const RENDER_DENSITY_FRAGMENT_SHADER_SOURCE = `#version 300 es
precision highp float;
in vec3 v_position;
in vec3 v_normal;
out vec4 o_color;
...
`;
  ...
  const RENDER_TEMPERATURE_FRAGMENT_SHADER_SOURCE = `#version 300 es
precision highp float;
in vec3 v_position;
in vec3 v_normal;
out vec4 o_color;
...
`;
  ...
  const initializeVelocityProgram = createProgramFromSource(
    gl,
    FILL_VIEWPORT_VERTEX_SHADER_SOURCE,
    INITIALIZE_VELOCITY_FRAGMENT_SHADER_SOURCE
  );
  const initializeSmokeProgram = createProgramFromSource(
    gl,
    FILL_VIEWPORT_VERTEX_SHADER_SOURCE,
    INITIALIZE_SMOKE_FRAGMENT_SHADER_SOURCE
  );
  const addBuoyancyForceProgram = createProgramFromSource(
    gl,
    FILL_VIEWPORT_VERTEX_SHADER_SOURCE,
    ADD_BUOYANCY_FORCE_FRAGMENT_SHADER_SOURCE
  );
